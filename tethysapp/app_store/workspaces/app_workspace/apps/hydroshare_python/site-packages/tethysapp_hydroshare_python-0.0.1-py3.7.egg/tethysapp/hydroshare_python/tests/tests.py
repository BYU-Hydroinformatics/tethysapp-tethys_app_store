...
# from ..app import HydrosharePython
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_python"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_python.tests.tests"

        To run tests in the HydrosharePythonTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_python.tests.tests.HydrosharePythonTestCase"

        To run only the test_if_tethys_platform_is_great function in the HydrosharePythonTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.hydroshare_python.tests.tests.HydrosharePythonTestCase.test_if_tethys_platform_is_great"
...
class HydrosharePythonTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(HydrosharePython)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(HydrosharePython)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/hydroshare-python/')  # The final '/' is essential for all pages/controllers
